...
<div class="mb-3">
    ...
    <select name="categorie_id" id="categorie_id"
        class="form-control @error('categorie_id') is-invalid @enderror" required
    ...
    @enderror
                    ...
                    <div class="form-group">
                        <label>Ce produit peut-il être dupliqué automatiquement ?</label>
                        <select name="duplicable" class="form-control">
